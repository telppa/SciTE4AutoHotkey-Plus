...
; These tools require the Windows SDK, Visual Studio or MinGW
...
Menu Tray, Icon, %A_ScriptDir%\..\Icons\%AppName%.ico
...
LoadSettings:
    ; Rename old ini file
    If (FileExist(A_AppData . "\AutoGUI\Size Checker.ini")) {
        FileMove %A_AppData%\AutoGUI\Size Checker.ini, %A_AppData%\AutoGUI\%AppName%.ini
    } Else If (FileExist("Size Checker.ini")){
        FileMove Size Checker.ini, %AppName%.ini
    }
