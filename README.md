...
#### 可在 [Github](https://github.com/telppa/SciTE4AutoHotkey-Plus/archive/refs/heads/master.zip "Releases") 或 [蓝奏云](https://ahk.lanzoui.com/i9oFkwjcm8d "蓝奏云") 下载最新打包版。  
---
...
> * 3.自动补全括号引号百分号。（http://blog.csdn.net/liuyukuan/article/details/8435485）（已取消，因为对单词进行补括号操作时会误补全）  
> * 4.漂亮的语法高亮文件。  
> * 5.中文翻译文件的些许修改与补全。  
